...
{
    public partial class Form2UserPass : Form 
    {
        public Form2UserPass()
        {
            InitializeComponent();
        }
        ...
        {
            Form2.instance.but1.Enabled = true;
            Form2.instance.but2.Enabled = true;
            Form2.instance.but3.Enabled = true;
            Form2.instance.but8.Enabled = true;
